...
<head>
    ...
    transition: background-color 0.2s ease-in-out, color 0.2s ease-in-out; /* Ajoutez une transition de couleur */
}

.btn-login:hover {
    background-color: #0056b3;
    color: white; /* Changez la couleur du texte en blanc au survol */
}
...
<body>
    ...
    <p class="footer">&copy; 2023 Rodriguez. Tout droits Reservé.</p>
    <style>
         .footer {
            text-align: center;
            color: #777;
