        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              <li class="nav-item">
              <nav class="nav-bar">
              <a class="nav-link larger-link " href="{{ url('/home47') }}">Home</a>
            <a class="nav-link larger-link " href="{{ url('/results20') }}">Résultats</a>
            <a class="nav-link larger-link color" href="{{ url('/schooling20') }}">Scolarité</a>
            <a class="nav-link larger-link " href="{{ url('/schedule20') }}">Plannig de cours</a>
            <a class="nav-link larger-link " href="{{ url('/news20') }}">News</a>
