        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              <li class="nav-item">
              <nav class="nav-bar">
              <a class="nav-link larger-link " href="{{ url('/home1') }}">Home</a>
            <a class="nav-link larger-link " href="{{ url('/results1') }}">Résultats</a>
            <a class="nav-link larger-link color" href="{{ url('/schooling1') }}">Scolarité</a>
            <a class="nav-link larger-link " href="{{ url('/schedule1') }}">Plannig de cours</a>
            <a class="nav-link larger-link " href="{{ url('/news1') }}">News</a>
