        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              <li class="nav-item">
              <nav class="nav-bar">
              <a class="nav-link larger-link " href="{{ url('/home16') }}">Home</a>
            <a class="nav-link larger-link " href="{{ url('/results16') }}">Résultats</a>
            <a class="nav-link larger-link color" href="{{ url('/schooling16') }}">Scolarité</a>
            <a class="nav-link larger-link " href="{{ url('/schedule16') }}">Plannig de cours</a>
            <a class="nav-link larger-link " href="{{ url('/news16') }}">News</a>
